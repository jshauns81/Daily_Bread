...
namespace Daily_Bread.Migrations
{
    ...
    public partial class AddScreenTimeMechanics : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Backfill: classify existing chores by their pay value. Paid chores (EarnValue > 0)
            // stay Kind=0 (Task); unpaid chores become Kind=1 (Routine). Runs while EarnValue exists.
            migrationBuilder.Sql("UPDATE \"ChoreDefinitions\" SET \"Kind\" = 1 WHERE \"EarnValue\" <= 0;");

            // Backfill: seed screen-time mechanics defaults on existing child profiles.
