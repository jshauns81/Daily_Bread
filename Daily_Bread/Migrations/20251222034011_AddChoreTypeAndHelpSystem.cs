...
{
    /// <inheritdoc />
    public partial class AddChoreTypeAndHelpSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarnValue = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    PenaltyValue = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    ScheduleType = table.Column<int>(type: "integer", nullable: false),
                    ActiveDays = table.Column<int>(type: "integer", nullable: false),
                    WeeklyTargetCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HelpReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    HelpRequestedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverrideValue = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChoreLogId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavingsGoals_IsActive",
                table: "SavingsGoals",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_SavingsGoals_IsPrimary",
                table: "SavingsGoals",
                column: "IsPrimary");
